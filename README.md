this dashboard shows oil data and visualizes the data in various ways, there are pie charts, line charts etc. it is not meant to be complicated everything is simple just showing a dash app in action.
